...
$(INST_SCRIPT)/eit_server.pl : script/eit_server.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	...
	$(CP) script/eit_server.pl $(INST_SCRIPT)/eit_server.pl
	$(FIXIN) $(INST_SCRIPT)/eit_server.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/eit_server.pl

$(INST_SCRIPT)/eit_create.pl : script/eit_create.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/eit_create.pl
	$(CP) script/eit_create.pl $(INST_SCRIPT)/eit_create.pl
...
$(INST_SCRIPT)/eit_fastcgi.pl : script/eit_fastcgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	...
	$(CP) script/eit_fastcgi.pl $(INST_SCRIPT)/eit_fastcgi.pl
	$(FIXIN) $(INST_SCRIPT)/eit_fastcgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/eit_fastcgi.pl
